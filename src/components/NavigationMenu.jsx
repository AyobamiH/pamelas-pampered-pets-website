...
//                     <Link to="/about" className='block mt-4 lg:inline-block lg:mt-0 text-black hover:text-gray-500 mr-4' >About</Link>
...
//                   <button className="block   mt-4 lg:inline-block lg:mt-0 text-white  py-2 px-4 rounded">
...
//             <div className={`w-full block flex-grow lg:flex lg:items-center lg:w-auto ${isOpen ? 'text-center ' : 'hidden'}`}>
//                 <div className="text-sm lg:flex-grow">
//                     <Link to="/about" className="block mt-4 lg:inline-block lg:mt-0 text-black hover:text-gray-500 mr-4">
//                         About
//                     </Link>
//                     <Link to="/services" className="block mt-4 lg:inline-block lg:mt-0 text-black hover:text-gray-500 mr-4">
//                         Services
//                     </Link>
//                     <Link to="/contact" className="block mt-4 lg:inline-block lg:mt-0 text-black hover:text-gray-500 mr-4">
//                         Contact
//                     </Link>
//                 </div>
//                 <div className="booking-button">
//                     <Link to="/booking-form">
//                         <button className="block mt-4 lg:inline-block lg:mt-0 bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">
//                             Book Now
//                         </button>
//                     </Link>
//                 </div>
                ...
                <div className="text-sm lg:flex-grow">
                    ...
                    <div className="booking-button flex justify-center mt-4 lg:mt-0 lg:flex-none">
                        <Link to="/booking-form">
                            ...
                            className="bg-[#40bfe0] hover:bg-[#40cff1] text-white font-bold py-2 px-4 rounded-full shadow transition duration-300 ease-in-out"
                                onClick={handleMenuItemClick}
                            >
                                Book Now
                            </button>
